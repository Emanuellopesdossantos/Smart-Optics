 ...
 * @author edmar
 */
public class Uisobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sistema Para Gereciamento De Consultas Para Óticas");

        jLabel2.setText("Desenvolvido por: Emanuel Lopes dos Santos");

        jLabel4.setText("Em desenvolvimento: !!!!");

        jLabel5.setText("Desenvolvido Com Java e Mysql Como Banco De Dados.");
